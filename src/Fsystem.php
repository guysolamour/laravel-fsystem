...
class Fsystem extends Filesystem
{
    ...
    public function compliedAndWriteFile($files, string $path, ?array $data_map = null, string $filename_prefix = '', string $extension = '.php')
    {
        $data_map ??= $this->data_map;
        /**
    ...
    public function renameFile(string $directory, string $old_name, string $new_name)
    {
     ...
     * @return void
     */
    public function compliedAndWriteFileRecursively($files, string $path, ?array $data_map = null)
    {
        /**
         * @var \Symfony\Component\Finder\SplFileInfo[]
         */
    ...
    public function replaceAndWriteFile($files, string $search, $replace, string $path)
    {
        /**
         * @var \Symfony\Component\Finder\SplFileInfo[]
         */
